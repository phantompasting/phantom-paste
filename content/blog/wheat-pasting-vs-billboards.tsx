  ...
  return (
    <>
      ...
      <p>
        ...
        or scrolling — placed on highways, major arterials, and city-center buildings. Bought
        through OOH networks (Clear Channel, Outfront, Lamar) on 4-week minimum flights at
        $4,000–$40,000 per board depending on market and placement.
      </p>
      <p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Lead time</td><td>4–8 weeks</td><td>7–10 days</td></tr>
          <tr><td>Flight length</td><td>4-week minimum</td><td>4–8 week natural lifespan</td></tr>
          <tr><td>Creative flexibility</td><td>Fixed art, permit review</td><td>Rotating designs, street vernacular</td></tr>
          <tr><td>Social amplification</td><td>Low</td><td>High — audience photographs walls</td></tr>
          <tr><td>Cultural signal</td><td>Mass-market, mainstream</td><td>Indie, credible, neighborhood-native</td></tr>
        </tbody>
      </table>

      <h2>When Billboards Win</h2>
      ...
      <h3>Streetwear, music, film, culture-driven brands</h3>
      <p>
      ...
      <ul>
        <li>Create a photograph that audiences voluntarily post to social</li>
        <li>Place your brand inside the specific block a target subculture lives on</li>
        <li>Respond to a cultural moment in under two weeks</li>
        <li>Deliver at sub-$0.50 CPM in the neighborhoods that matter to streetwear and music</li>
      </ul>

      <h2>What Wheat Paste Can&apos;t Do</h2>
      <ul>
        <li>Scale to 100K+ daily impressions on a single placement</li>
        <li>Deliver audience via car commute corridors</li>
      ...
      <ol>
        <li>
          <strong>Is the audience under 35 and concentrated in specific urban neighborhoods?</strong>{" "}
          Yes → wheat paste is probably the right primary buy.
        </li>
        <li>
          <strong>Does the brand need measured reach at scale for mass-market categories?</strong>{" "}
          Yes → billboards are probably the right primary buy.
        </li>
      </ol>
      <p>
