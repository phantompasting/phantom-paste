...
const FOOTER_STATE_GROUPS: FooterStateGroup[] = [
  ...
  { name: "Ohio",          href: "/locations/ohio",
    cities: [{ label: "Columbus" }, { label: "Cleveland" }, { label: "Cincinnati" }, { label: "Dayton" }] },
  { name: "North Carolina", href: "/locations/north-carolina",
    cities: [{ label: "Charlotte" }, { label: "Raleigh" }, { label: "Durham" }, { label: "Asheville" }] },
  { name: "Michigan",      href: "/locations/michigan",
    cities: [{ label: "Detroit" }, { label: "Grand Rapids" }, { label: "Ann Arbor" }] },
  { name: "New Jersey",    href: "/locations/new-jersey",
    cities: [{ label: "Jersey City" }, { label: "Hoboken" }, { label: "Newark" }] },
  { name: "Virginia",      href: "/locations/virginia",
    cities: [{ label: "Richmond" }, { label: "Virginia Beach" }, { label: "Norfolk" }, { label: "Arlington" }] },
  { name: "Indiana",       href: "/locations/indiana",
    cities: [{ label: "Indianapolis" }, { label: "Bloomington" }, { label: "Fort Wayne" }] },
  { name: "Missouri",      href: "/locations/missouri",
    cities: [{ label: "Kansas City" }, { label: "St. Louis" }, { label: "Columbia MO" }] },
  { name: "Maryland",      href: "/locations/maryland",
    cities: [{ label: "Baltimore" }, { label: "Silver Spring" }, { label: "Annapolis" }] },
  { name: "Wisconsin",     href: "/locations/wisconsin",
    cities: [{ label: "Milwaukee" }, { label: "Madison" }, { label: "Green Bay" }] },
  { name: "Minnesota",     href: "/locations/minnesota",
    cities: [{ label: "Minneapolis" }, { label: "St. Paul" }, { label: "Duluth" }] },
];
