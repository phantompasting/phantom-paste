...
/** Desktop-only Cities nav item with hover dropdown */
export default function NavCitiesMenu() {
      ...
      {open && (
        <div className="absolute top-full left-1/2 pt-1 z-50" style={{ transform: "translateX(-50%)" }}>
          ...
          >
            ...
            <a
              href="/locations"
              className="flex items-center gap-2.5 font-mono text-[11px] tracking-[0.22em] uppercase no-underline px-4 py-2.5 border-b"
