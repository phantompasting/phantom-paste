...
export const metadata: Metadata = {
  title: { absolute: "Wheat Pasting Texas | Houston + Dallas Wheatpasting" },
  description:
...
const data: CityPageData = {
  ...
  heroImage1: { src: "/gallery/vaura-pilates-sidewalk-chalk-stencil-guerrilla-marketing-austin.webp", alt: "Vaura Pilates sidewalk chalk stencil guerrilla marketing Austin Texas" },
  heroImage2: { src: "/gallery/fifa-world-cup-poster-installation-closeup.webp", alt: "FIFA World Cup wheat paste poster installation close-up" },
