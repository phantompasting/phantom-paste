...
export const metadata: Metadata = {
  title: { absolute: "Wheat Pasting Washington State | Seattle Wheatpasting" },
  description:
...
const data: CityPageData = {
  ...
  heroImage1: { src: "/gallery/wheat-paste-crew-power-washing-wall-los-angeles.webp", alt: "Wheat paste crew power washing wall prep" },
  heroImage2: { src: "/gallery/custom-stencil-template-cut-out-design.webp", alt: "Custom stencil template cut-out guerrilla marketing design" },
