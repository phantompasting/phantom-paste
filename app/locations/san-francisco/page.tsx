...
const data: CityPageData = {
  ...
  faqs: [
    ...
    { q: "How much does an SF wheat pasting campaign cost?", a: "Single-neighborhood test: $3,500-$6,500 for 60-90 posters. Full-city activation across 4-5 districts: $15K-$22K. Combined SF + LA California briefs run $28K-$48K depending on multi-week refresh requirements." },
