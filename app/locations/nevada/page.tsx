...
export const metadata: Metadata = {
  title: { absolute: "Wheat Pasting Nevada | Vegas + Reno Wheatpasting" },
  description:
...
const data: CityPageData = {
  ...
  heroImage1: { src: "/gallery/wheat-paste-wall-blank-before-install-los-angeles.webp", alt: "Blank wall prepped before wheat paste install" },
