...
export const metadata: Metadata = {
  title: { absolute: "Wheat Pasting Houston | Montrose Wheatpasting Posters" },
  description:
...
const data: CityPageData = {
  ...
  faqs: [
    ...
    { q: "How much does a Houston wheat pasting campaign cost?", a: "Single-neighborhood test: $3,200-$5,500 for 60-90 posters. Full-city activation across 4-5 districts: $11K-$18K. Lower than LA + NYC at comparable foot-traffic densities — Houston's wall-space competition is dramatically lower." },
