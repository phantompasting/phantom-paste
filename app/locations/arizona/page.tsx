...
export const metadata: Metadata = {
  title: { absolute: "Wheat Pasting Arizona | Statewide Wheatpasting Posters" },
  description:
...
const data: CityPageData = {
  ...
  heroImage1: { src: "/gallery/black-pearl-la-stencil-template-grass.webp", alt: "Black Pearl LA stencil template grass surface" },
