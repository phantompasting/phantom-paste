...
export const metadata: Metadata = {
  title: { absolute: "Wheat Pasting Massachusetts | Boston Wheatpasting" },
  description:
...
const data: CityPageData = {
  ...
  heroImage1: { src: "/gallery/dont-fall-off-wheat-paste-building-bike-rack.webp", alt: "Wheat paste poster building with bike rack" },
