...
export const metadata: Metadata = {
  title: { absolute: "Wheat Pasting Georgia | Atlanta Wheatpasting Statewide" },
  description:
...
const data: CityPageData = {
  ...
  heroImage1: { src: "/gallery/fifa-world-cup-poster-wall-street-perspective.webp", alt: "FIFA World Cup wheat paste poster wall street perspective Atlanta" },
  heroImage2: { src: "/gallery/fifa-world-cup-street-gallery-pedestrian-viewing.webp", alt: "FIFA World Cup street gallery with pedestrians viewing Atlanta" },
  areaLabel: "CITIES SERVED",
  serviceAreaType: "State",
  lastUpdated: "2026-04-25",
  pricingTiers: [
    { tier: "Single-City GA Campaign", range: "$3,200 – $6,500", includes: "Atlanta on the higher end · 1 GA metro · Photo doc + install report" },
    { tier: "Statewide GA Rollout", range: "$15K – $28K", includes: "4–6 metros · Multi-city volume discount · Unified statewide reporting" },
  ],
  faqs: [
