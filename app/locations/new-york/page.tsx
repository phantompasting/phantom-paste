...
export const metadata: Metadata = {
  title: { absolute: "Wheat Pasting NYC | LES + Brooklyn Wheatpasting Posters" },
  description:
...
const data: CityPageData = {
  ...
  faqs: [
    ...
    { q: "What is wild posting in NYC?", a: "Wild posting is the industry term for wheat-paste poster advertising — grids of paper posters installed on walls, construction barricades, and scaffolding across NYC neighborhoods. Same format, same walls, same crews; agencies say wild posting, street culture says wheat pasting, UK briefs say flyposting. In New York it concentrates in the Lower East Side, SoHo, Williamsburg, and Bushwick, where pedestrian density makes every wall a walking-pace audience." },
    { q: "How much does wild posting cost in NYC?", a: "NYC wild posting runs the same as wheat pasting: $4,500-$8,500 for a single-neighborhood test of 80-120 posters, $15K-$25K for a two-crew Manhattan + Brooklyn activation. Per-poster costs drop as volume rises, and Brooklyn wall rights average 15-20% below Manhattan equivalents. Every campaign includes GPS-logged install documentation." },
    { q: "Do you offer wild posting services in NYC?", a: "Yes — wild posting is our core NYC service. We handle wall sourcing, printing, overnight installs, and photo documentation across all five boroughs, with the heaviest rotation in the Lower East Side, Williamsburg, SoHo, and Bushwick. One crew, one point of contact, from creative specs to the morning-after documentation pass." },
    { q: "Where does wild posting work best in Manhattan?", a: "Below 14th Street: the Lower East Side (Ludlow, Orchard, Rivington) and SoHo (Lafayette, Mercer) carry Manhattan's densest wall culture and foot traffic. The East Village and Chelsea/Meatpacking round out the paste map. Midtown is a scaffold-wrap market — DOB-permitted wraps instead of standard paste — which we also manage." },
    ...
    { q: "Do you offer mural advertising in Williamsburg and the Bronx?", a: "Yes — commissioned, hand-painted murals through our managed mural service. Williamsburg's walls already mix murals and posters on the same corners, and the South Bronx carries the deepest mural lineage in the country, with Mott Haven's gallery wave turning it into commission demand. We run murals and wheat paste in both, so a painted anchor can launch with paste amplification around it." },
  ],
  spotlight: {
